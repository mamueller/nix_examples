...
known_hosts()
{
   set -A kh vayu cher pear shin jigg nXXX raij ces2 Geor
}


## nix-based gfortran environment
host_Geor()
{
   export NCDIR='/home/mm/.nix-profile/lib'
   export NCMOD='/home/mm/.nix-profile/include'
   export FC=gfortran
   export CFLAGS='-O2 -x f95-cpp-input'
   export LD='-lnetcdf -lnetcdff'
   export LDFLAGS='-L/home/mm/.nix-profile/lib -O2'
   build_build
   cd ../
   build_status
}
...
#   #export LD='-lnetcdf'
#   export LD=' -L/home/mm/local/lib -lnetcdff -L/home/mm/local/lib -lnetcdf -lnetcdf'
